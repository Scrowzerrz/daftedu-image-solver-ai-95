        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-6">
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 bg-white hover:bg-gray-50 border-2 border-gray-200 hover:border-gray-300 transition-all duration-200 group relative overflow-hidden"
